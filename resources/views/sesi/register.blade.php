                    ...
                    <div class="card-body p-4 p-lg-5 text-black">
                      ...
                      <form action="/sesi/store" method="POST">
                        ...
                        <div class="d-flex align-items-center mb-3 pb-1">
                          ...
                          <span class="h1 fw-bold mb-0">Registrasi KPPS</span>
                        </div>
                        ...
                        <div class="form-outline mb-4">
                          <input type="hidden" id="form2Example17" class="form-control form-control-sm" name="type" value="pengunjung" autocomplete="off"/>
                        </div>
